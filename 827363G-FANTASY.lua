...
local fixedPositions = {
    {name="Pos1",x=-764.2021484375,y=29.153287887573243,z=-430.17047119140627},
    {name="Pos2",x=-521.14453125,y=177.21002197265626,z=-269.22943115234377},
    {name="Pos3",x=-407.7820739746094,y=283.7674255371094,z=170.99127197265626},
    {name="Pos4",x=-13.74642562866211,y=265.5819091796875,z=349.53289794921877},
    {name="Pos5",x=293.4115295410156,y=326.25457763671877,z=432.0643310546875},
    {name="Pos6",x=625.434814453125,y=304.3566589355469,z=509.9645080566406},
    {name="Pos7",x=1186.55908203125,y=749.2843627929688,z=599.57470703125},
    {name="Pos8",x=1095.342529296875,y=871.278564453125,z=878.6813354492188},
    {name="Pos9",x=-472.61737060546877,y=1268.6187744140626,z=994.4490356445313},
    {name="Pos10",x=-967.1437377929688,y=1518.381103515625,z=1440.195068359375},
    {name="Pos11",x=-971.1646118164063,y=1523.381103515625,z=1445.054443359375},
    {name="Pos12",x=-979.4879150390625,y=1523.381103515625,z=1453.0826416015626},
    {name="Pos13",x=-985.6578369140625,y=1523.381103515625,z=1458.6982421875},
    {name="Pos14",x=-992.7098999023438,y=1523.381103515625,z=1464.8125},
}
    ...
    comboThread = task.spawn(function()
        ...
        while comboRunning and currentIndex <= #fixedPositions do
            ...
            if currentIndex > #fixedPositions and comboRunning then
                ...
                showCenterMessage("JIKA TIDAK MATI HARAP RESPAWN MANUAL", 3.5)
        ...
        notify("Selesai","jika gabisa di start harap execute ulang.",2)
    end)
end
